...
proto = (r"F:\Aadhi\python\MobileNetSSD_deploy.caffemodel")
model = (r"F:\Aadhi\python\MobileNetSSD_deploy.prototxt")
...
def main():
    cap = cv2.VideoCapture((r"F:\Aadhi\python\testvideo2.mp4"))
